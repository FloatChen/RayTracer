function [ Yout, xout, hnext, maxcount ] = rkqc(Y,dydx,fr,x,htry,eps,Yscale,hmin)
...
while hnext == 0 && maxcount < 5
    ...
    % Short Step
    [Yshort, xshort] = rk4(Y,dydx,fr,x,hh);
    dydx_2 = getderivs(Yshort,fr);
    [Yshort, ~] = rk4(Yshort,dydx_2,fr,xshort,hh);
    
    % Larg Step
    [Ylong, xout] = rk4(Y,dydx,fr,x,h);
